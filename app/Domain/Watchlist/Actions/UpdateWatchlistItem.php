...
final readonly class UpdateWatchlistItem
{
    ...
    public function handle(User $user, WatchlistItem $item, WatchlistStatus $status, bool $active, ?ResearchProject $project, ?string $note, ?TopicWorkspace $workspace = null): WatchlistItem
    {
